...
tbl_names_popular |> 
  ...
  labs(
    title = 'Top 5 Baby Name (Female and Male) in US',
    subtitle = '',
    caption = 'Source: SSA',
    x = 'Number of Birth',
    y = 'Name'
...
tbl_names_by_letter |> 
  ...
  labs(
    title = 'The Distribution of Births By First Letter',
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
      title = "Heatmap of The Distribution of Percentage Births",
      subtitle = "By Last Letter and First Letter",
      caption = "Source: SSA",
      x = "First Letter",
      y = "Last Letter",
...
tbl_names_vowel_consonant |> 
  ...
  labs(
      ...
      subtitle = "Percentage of Births by First Letter and Last Letter",
      caption = "Source: SSA",
      x = "Year",
      y = "Percentage of Births",
    ) +
